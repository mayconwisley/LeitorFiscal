...
public class HorarioContratualAEJ
{
    ...
    [MaxLength(30, ErrorMessage = "O campo CodHorContratual deve ser um tipo de cadeia de caracteres com um comprimento máximo de '30'")]
    [MinLength(1, ErrorMessage = "O campo CodHorContratual deve ser um tipo de cadeia de caracteres com um comprimento minimo de '1'")]
    public string? CodHorContratual { get; set; }
    [MaxLength(12, ErrorMessage = "O campo DurJornada deve ser um tipo de cadeia de caracteres com um comprimento máximo de '12'")]
    [MinLength(1, ErrorMessage = "O campo DurJornada deve ser um tipo de cadeia de caracteres com um comprimento minimo de '1'")]
    public string? DurJornada { get; set; }
    [MaxLength(4, ErrorMessage = "O campo HrEntrada01 deve ser um tipo de cadeia de caracteres com um comprimento máximo de '4'")]
    [MinLength(4, ErrorMessage = "O campo HrEntrada01 deve ser um tipo de cadeia de caracteres com um comprimento minimo de '4'")]
    public string? HrEntrada01 { get; set; }
    [MaxLength(4, ErrorMessage = "O campo HrSaida01 deve ser um tipo de cadeia de caracteres com um comprimento máximo de '4'")]
    [MinLength(4, ErrorMessage = "O campo HrSaida01 deve ser um tipo de cadeia de caracteres com um comprimento minimo de '4'")]
    public string? HrSaida01 { get; set; }
    [MaxLength(4, ErrorMessage = "O campo HrEntrada02 deve ser um tipo de cadeia de caracteres com um comprimento máximo de '4'")]
    ...
    [MaxLength(4, ErrorMessage = "O campo HrEntrada04 deve ser um tipo de cadeia de caracteres com um comprimento máximo de '4'")]
    public string? HrEntrada04 { get; set; }
    [MaxLength(4, ErrorMessage = "O campo HrSaida04 deve ser um tipo de cadeia de caracteres com um comprimento máximo de '4'")]
    public string? HrSaida04 { get; set; }
    [MaxLength(4, ErrorMessage = "O campo HrEntrada05 deve ser um tipo de cadeia de caracteres com um comprimento máximo de '4'")]
    public string? HrEntrada05 { get; set; }
    [MaxLength(4, ErrorMessage = "O campo HrSaida05 deve ser um tipo de cadeia de caracteres com um comprimento máximo de '4'")]
    public string? HrSaida05 { get; set; }
    [MaxLength(4, ErrorMessage = "O campo HrEntrada06 deve ser um tipo de cadeia de caracteres com um comprimento máximo de '4'")]
