...
public class CabecalhoAFD595
{
    ...
    public static List<CabecalhoAFD595> CabecalhoAfdList { get; private set; } = new();
    ...
    {
        CabecalhoAFD595 cabecalho;

        int tamanhoLinha = linhaArquivo.Length;

        if (tamanhoLinha != 236)
        {
            ErrosValidacao.Add($"O registro '1 - Cabeçalho' possui o tamanho de caracteres diferentes que o definido pelas a Portaria n.º 595, de 05 de dezembro de 2013. Tamanho encontrado: {tamanhoLinha}\n");
            return;
        }
        else
        {
    ...
    private static bool ValidarTipoDados(CabecalhoAFD595 cabecalhoAFD, string linha)
    {
