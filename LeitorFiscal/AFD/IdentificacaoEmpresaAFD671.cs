...
public class IdentificacaoEmpresaAFD671
{
    ...
    public string? CpfResponsavel { get; private set; } /*Tamanho: 14, Posição: 35 a 48, Tipo: numérico*/
    ...
    public string? TpIdentEmpregador { get; private set; } /*Tamanho: 1, Posição: 49 a 49, Tipo: numérico, Dado: = 1-CNPJ ou 2-CPF*/
    ...
    public string? CnpjCpf { get; private set; } /*Tamanho: 14, Posição: 50 a 63, Tipo: numérico*/
    ...
    public string? Cno { get; private set; } /*Tamanho: 14, Posição: 64 a 77, Tipo: numérico, Não Obrigatório*/
    ...
    public string? RazaoSocial { get; private set; } /*Tamanho: 150, Posição: 78 a 227, Tipo: alfanumérico*/
    ...
    public string? LocalPrestServico { get; private set; } /*Tamanho: 100, Posição: 228 a 327, Tipo: alfanumérico*/
    ...
    public string? Crc16 { get; private set; } /*Tamanho: 4, Posição: 328 a 331, Tipo: alfanumérico*/
    ...
    private static bool ValidarTipoDados(IdentificacaoEmpresaAFD671 identificacaoEmpresa, string linha)
    {
