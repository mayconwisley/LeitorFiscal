...
public class TempoRealAFD1510
{
    ...
    public static List<TempoRealAFD1510> TempoRealRepAfdList { get; private set; } = new();
    ...
    private static bool ValidarTipoDados(TempoRealAFD1510 tempoRealRep, string linha)
    {
