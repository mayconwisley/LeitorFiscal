...
public class TempoRealAFD671
{
    ...
    public string? DataHoraDoAjuste { get; private set; } /*Tamanho: 24, Posição: 11 a 34, Tipo: numérico, Formato: AAAA-MM-ddThh:mm:00ZZZZZ*/
    ...
    public string? DataHoraAjustada { get; private set; } /*Tamanho: 24, Posição: 35 a 58, Tipo: numérico, Formato: AAAA-MM-ddThh:mm:00ZZZZZ*/
    ...
    public string? CpfResponsavel { get; private set; } /*Tamanho: 11, Posição: 59 a 69, Tipo: numérico*/
    ...
    private static bool ValidarTipoDados(TempoRealAFD671 tempoRealRep, string linha)
    {
