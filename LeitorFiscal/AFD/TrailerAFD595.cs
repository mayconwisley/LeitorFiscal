...
public class TrailerAFD595
{
    ...
    public string? TpRegistro { get; private set; } /*Tamanho: 1, Posição 55 a 55, Tipo: numérico, Dado: = 9*/
    ...
    {
        TrailerAFD595 trailer;
        int tamanhoLinha = linhaArquivo.Length;
        if (tamanhoLinha != 55)
        {
            ErrosValidacao.Add($"O registro de '9 - Trailer' possui o tamanho de caracteres diferentes que o definido pela a Portaria n.º 595, de 05 de dezembro de 2013. Tamanho encotrado {tamanhoLinha}\n");
            return;
        }
        else
        {
