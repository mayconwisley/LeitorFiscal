...
public class TrailerAFD671
{
    ...
    public string? QtdRegTipo6 { get; private set; } /*Tamanho: 9, Posição: 46 a 54, Tipo: numérico*/
    ...
    public string? QtdRegTipo7 { get; private set; } /*Tamanho: 9, Posição: 55 a 63, Tipo: numérico*/
    ...
    public string? TpRegistro { get; private set; } /*Tamanho: 1, Posição 64 a 64, Tipo: numérico, Dado: = 9*/

    public static List<TrailerAFD671> TrailerAfdList { get; private set; } = new();
    ...
    private static bool ValidarTipoDados(TrailerAFD671 trailer, string linha)
    {
